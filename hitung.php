<?php
    ...
    if($masakerja <= 0 || $gaji <= 0){
        ...
        $z5 =0;
        $z6 =0;
        $R1=min($masakerjabaru,$gajiSedikit);//maka binus sedikit
        $z1=600000-(300000*$R1);
        $R2=min($masakerjabaru,$gajiBanyak);//maka binus sedikit
        $z2=600000-(300000*$R1);
        $R3=min($masakerjaSedang,$gajiSedikit);//maka binus sedikit
        $z3=600000-(300000*$R1);
        $R4=min($masakerjaSedang,$gajiBanyak);//maka binus banyak
        $z4=600000-(300000*$R1);
        $R5=min($masakerjaLama,$gajiSedikit);//maka binus banyak
        $z5=600000-(300000*$R1);
        $R6=min($masakerjaLama,$gajiBanyak);//maka binus banyak
        $z6=600000-(300000*$R1);
...
<div>
    <div>
        <center>
            <table>
                ...
                <tr>
                    ...
                    <td align="center" valign="middle" class="pt10"><?php echo number_format($bonus,2,",",".");?>Juta</td>
                    <td align="center" valign="middle">
        ...
        <center><table>
            ...
            <tr>
            <td></td>
            <td colspan="6">Nilai Bonus = SUM(R1*Z1)/SUM(R1) =<?php echo round($total_RiZi,2)."/".round($total_R,3);?> = Rp. <?php echo number_format($bonus,2,",",".") ?></td>
            </tr> 
        </table> </center>
...
$masakerjaLama = round($masakerjaSedang,2);
$masakerjaSedang =round($masakerjaLama,2);
if ($masakerjaBaru==0){
